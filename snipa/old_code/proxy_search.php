					...
					<tbody>
						...
						<tr id="snps_sentinels">
							...
							<td class="description">
								...
								If you have already added variants to SNiPA's clipboard, these are available as a preselection.<br />
						...
						<tr id="snps_gene">
							...
							<td class="description">
								Enter an ENSEMBL gene identifier (e.g. ENSG00000015532).<br />You may also enter identifiers from other gene resources and then select the appropriate ENSEMBL gene identifier from the list.<br /> SNiPA will perform a proxy search for all sentinel SNPs covered by that gene. 
								<br /><br />
