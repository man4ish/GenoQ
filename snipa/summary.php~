...
<script>
$("#includedContent2").load('plot.html');

  $(function(){
      
      var imgpath='tmpdata/'+'<?php echo $id; ?>'+'/barplot.html';
      //alert(imgpath);
      //imgpath='plot.html';
      alert(imgpath);
      $("#includedContent").load(imgpath); 
    });
 
$(function(){
      piepath='tmpdata/'+'<?php echo $id; ?>'+'/piechart.html';
      $("#piechart").load(piepath); 
...
else 
{
    ...
    $cmd="/home/metabolomics/snipa/tools/tabix-0.2.6/tabix /home/metabolomics/snipa/data/genomic/grch37/genoq/qtr/qtrdb/genoq/qatar/Qatar_merge_file.annotation.gz ".$chr.":".$start."-".$stop;
    ...
    //$statfilefh = fopen($tmpdatadir."/qatar.txt",'w');
    //fwrite($statfilefh, utf8_encode(json_encode($status)));
    //fclose($statfilefh);
...
fclose($file_handle);
    ...
    print("\n".$Rplotcmd."\n");
     ...
     $file = fopen($JobDir."data.json","w");
     $rcmd = "[{\"type\": \"pie\",\"name\": \"SNPs\",\"data\": [[\"Downrstream\",".$downstream."],[\"Intron\",".$intron."],[\"Non Synonymous Coding\",".$nsn."],[\"Synonymous Coding\",".$syn."],[\"Upstream\",".$upstream."],[\"UTR 3 Prime\",".$utr3."],[\"UTR 5 Prime\",".$utr5."]]}]";

/*,$downstream,"],[\"Intron\",",$intron,"],[\"Non Synonymous Coding\"
,",as.numeric(args[3]),"],[\"Synonymous Coding\",",$syn,"],[\"Ups
tream\",",$upstream,"],[\"UTR 3 Prime\",",$utr3,"],[\"UT
R 5 Prime\",",$utr5,"]]}]";*/

     echo fwrite($file,$rcmd);
     fclose($file);

    

    /*$rcmd = cat("[{\"type\": \"pie\",\"name\": \"SNPs\",\"data\": [[\"Downrstream\",",as.num
eric(args[1]),"],[\"Intron\",",as.numeric(args[2]),"],[\"Non Synonymous Coding\"
,",as.numeric(args[3]),"],[\"Synonymous Coding\",",as.numeric(args[4]),"],[\"Ups
tream\",",as.numeric(args[5]),"],[\"UTR 3 Prime\",",as.numeric(args[6]),"],[\"UT
R 5 Prime\",",as.numeric(args[7]),"]]}]",file=paste0(jobdir,"data.json"),"\n")*/
	
    


    exec("echo 'genoq' | sudo -S ".$Rplotcmd);
    

    $Rplotcmd="Rscript --vanilla  ".$Rcodedir."/RCode/piechart.R ".$downstream." ".$intron." ".$nsn." ".$syn." ".$upstream." ".$utr3." ".$utr5." ".$JobDir;
    //print("\n".$Rplotcmd."\n");
    exec("/usr/bin/ ".$Rplotcmd);
 


    $cmd="/home/metabolomics/snipa/tools/tabix-0.2.6/tabix /home/metabolomics/snipa/data/genomic/grch37/genoq/qtr/qtrdb/genoq/1000G/1000G_records_sorted.ann.file.vcf.gz ".$chr.":".$start."-".$stop;
    ...
    $dbsnpcmd="/home/metabolomics/snipa/tools/tabix-0.2.6/tabix /home/metabolomics/snipa/data/genomic/grch37/genoq/qtr/qtrdb/genoq/dbsnp/dbSNP.ann.file.gz ".$chr.":".$start."-".$stop;
...
$file = fopen($JobDir."/VennDiagram.R","w");
$rcmd="library(VennDiagram); venn.plot <- draw.triple.venn(area1 =". $totalsnps.",";
$rcmd.="area2 =as.numeric(".$thousandtotalsnps."),";
$rcmd.="area3 =as.numeric(".$dbsnparrlength."),";
$rcmd.="n12 =as.numeric(".$thousandcommoncount."),";
$rcmd.="n23 =as.numeric(".$thousanddbsnp."),";
$rcmd.="n13 =as.numeric(".$dbsnpcommoncount."),";
$rcmd.="n123 =as.numeric(".$intersection."),";
$rcmd.="category =". "c(\"GenoQ\", \"1000 Genome\", \"dbSNP\")".",";
$rcmd.="fill="."c(\"blue\", \"red\", \"green\")".",";
$rcmd.="lty = \"blank\",";
$rcmd.="cex = 8,";
$rcmd.="cat.cex = 8,";
$rcmd.="cat.col = c(\"blue\", \"red\", \"green\"))";
fwrite($file,$rcmd);
fclose($file);
    ...
    $Rcmd="/usr/bin/sudo Rscript --vanilla  ".$Rcodedir."/RCode/VennDiagram.R ".$totalsnps." ".$thousandtotalsnps." ".$dbsnparrlength." ".$thousandcommoncount."  ".$thousanddbsnp." ".$dbsnpcommoncount." ".$intersection." ".$JobDir;
    exec($Rcmd);
    //print ("\n\n\n\n\n\n\n".$Rcmd."\n\n\n\n\n\n\n\n\n\n");
