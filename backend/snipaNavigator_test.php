...
if($static_plot==0)
{
 ...
 //fclose($test); 
  ...
  echo exec( 'Rscript generatematrix_annotation.R ' . $flname . ' ' . $Population . ' ' . $zoomlevel . " 0 ".$mousetracking.' '.$JobDir); 
  ...
  echo exec( 'Rscript generatematrix_annotation.R ' . $qtrflname . ' ' . $Population . ' ' . $zoomlevel . " 1 ".$mousetracking.' '.$JobDir);
}
else
{
