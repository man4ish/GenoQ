...
// Options
define ('BATIK_PATH', '/home/metabolomics/snipa/tools/batik-1.7/batik-rasterizer.jar');
//define ('BATIK_PATH', '/home/metabolomics/snipa/tools/batik-1.8/batik-1.8.jar');
...
// workaround for batik bug 45520 (issue with safari and link for background image)
$svg = str_replace("NS1:href","xlink:href",$svg);
...
// do the conversion
$output = shell_exec("java -jar ". BATIK_PATH ." $typeString -font-family Ubuntu -d $outfile $width temp/$tempName.svg");
