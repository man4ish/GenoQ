...
<!-- Replace function snipaNavigator.php and snipaNavigator2.php -->
<html>
  <head>
  ...
  <script type='text/javascript'>
	...
	var options = {
       ...
       function myFunction() 
       {                      
                 $("#container").html('<div id="container" style="width: 850px; height: 850px; margin: 0px"><img src ="tmpdata/<?php echo $_GET['pid']; ?>/polygon.png?c=' + new Date().getTime() + '" style="width: 850px; height: 850px; margin: 0px"></div>');
       } 

     var title_text="";
     var plotLineVal=0;
     
     $.getJSON("tmpdata/"+"<?php echo $_GET['pid']; ?>"+"/title.json", function(title_data) {
     ...
     $.getJSON('frontend/js/tmp/title.json', function(title_data) { 
      ...
      $.get(summaryfile, function(data) {  
               ...
               if (range > 10000){
                    ...
                    $("#container").html('<div  id="container" style="width: 850px; height: 850px;margin: 0px" > <img src ="tmpdata/<?php echo $_GET['pid']; ?>/polygon.png" style="width: 850px; height: 850px; margin: 0px"></div>');
	            return false;
               }
		...
		//start=parseInt(start)-2000;
                ...
                if ((range+4000) > 10000)
                {
                    ...
                    if (range > 10000)
                    {
                      ...
                      $("#container").html("<p class='spinner'><center><i class='fa fa-circle-o-notch fa-spin' style='font-size:50px'></center></i></p>"); 
                      $.get( "backend/snipaNavigator.php?recordID=1&chr="+chr+"&genomerelease="+genomerelease+"&annotation="+annotation+"&referenceset="+referenceset+"&population="+population+"&jobid="+jobid+"&start="+start+"&stop="+stop, function( data ) {})        
	...
	$("#minus").click(function() {
		...
		if (range > 10000)
                ...
                alert("backend/snipaNavigator.php?recordID=0&chr="+chr+"&genomerelease="+genomerelease+"&annotation="+annotation+"&referenceset="+referenceset+"&population="+population+"&jobid="+jobid+"&start="+start+"&stop="+stop);
		$.get( "backend/snipaNavigator.php?recordID=0&chr="+chr+"&genomerelease="+genomerelease+"&annotation="+annotation+"&referenceset="+referenceset+"&population="+population+"&jobid="+jobid+"&start="+start+"&stop="+stop, function( data ) {
                        alert("tmpdata/<?php echo $_GET['pid']; ?>/data0.json");
              var jqxhr = $.getJSON( "tmpdata/<?php echo $_GET['pid']; ?>/data0.json", function(data) {
                 options.title.text=title_text;
   ...
   <!-- <table width="100%" cellspacing="0" cellpadding="0">
    ...
    <td>                                                        <input type="text" size=14 id="searchbox" /><input id ="generate_ldheat_map" type="submit"></td></tr></table>-->
         ...
         <div  id="container" style="width: 850px; height: 850px;margin: 0px" > <img src ="tmpdata/<?php echo $_GET['pid']; ?>/polygon.png" style="width: 850px; height: 850px; margin: 0px"></div>
