...
function heatmap() {
      var res=0;
      //alert("frontend/js/ldheatmap.php?pid="+processid);    
      $('#plots-tabs-heatmap').load("frontend/js/ldheatmap.php?pid="+processid);
      $.get('frontend/js/result.log', function(data) {
      		res = data.split("\t");      		
      		range = (parseInt(res[7])-parseInt(res[6]));
      		//if(range > 10000)
                {
 			//$('#plots-tabs-heatmap').load("frontend/js/sample.php?pid="+processid);
                }
      		/*else {
                        $('#plots-tabs-heatmap').load("frontend/js/code.html");
                }*/
    });
}
		   ...
		   success: function(data){
			   ...
			   if(data){
					...
					$("#message").html(message+"..");
                                        /*if(pbvalue==100){//$("#progressbar").hide(); $("#message").hide(); $('#progress-dialog').dialog("close"); 
                                          alert("done");
                                        }*/
				}
